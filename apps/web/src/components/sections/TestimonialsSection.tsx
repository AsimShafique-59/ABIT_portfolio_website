      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-4">
            ...
            <br />
            <span className="text-blue-600">the UK & Europe</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.name}
              className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm card-hover relative"
            >
              {/* Quote mark */}
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-6 relative z-10">{t.quote}</p>
